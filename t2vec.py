...
parser.add_argument("-C", default=1,
                    help="Rate of user per round")

parser.add_argument("-test_ratio", default=0.3,
                    help="ratio of test_dataset")

parser.add_argument("-E", default=1,
                    help="Epoch per iteration")
...
if args.mode == 1:
    ...
    trainer.train(args)
    # trainer.getTrajInfo(1000)
    # for number_k in range(40, 50, 10):
    #     # print('distort ',number_k, 0)
    #     # trainer.total_KnnQuery_distort(number_k, 0)
    #     for i in range(2, 3):
    #         ratio = i / 10
    #         print('distort ',number_k, ratio)
    #         trainer.total_KnnQuery_distort(number_k, ratio)
    #         # trainer.preprocess(ratio)
    # for number_k in range(40,50,10):
    #     print('drop ',number_k, 0)
    #     trainer.total_KnnQuery(number_k,0)
    #     for i in range(2,3):
    #         ratio = i / 10
    #         print('drop ',number_k, ratio)
    #         trainer.total_KnnQuery(number_k,ratio)
    #         # trainer.preprocess(ratio)
